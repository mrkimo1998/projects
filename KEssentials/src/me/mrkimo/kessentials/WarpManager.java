...
public class WarpManager {
    ...
    public WarpManager(String warpFileName, JavaPlugin plugin) {
        ...
        log.info("WarpFileLocation is " + warpFileLocation);
    }

    /**
     * Returns the WarpPoint with the specified name. If there is no WarpPoint
     ...
     * 0 : Success 1 : WarpPoint with that name already exists 2 : Other error
